    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-dark-bg font-sans flex justify-center items-center p-4">
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Jadwal Ustadz</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-2">Masuk untuk mengelola jadwal dakwah Anda</p>
        </div>
        ...
        <div className="card-timbul">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm text-gold-primary font-medium hover:underline">
                Lupa Password?
              </Link>
            </div>

            <button disabled={loading} type="submit" className="w-full btn-timbul mt-2">
              Masuk
            </button>
          </form>
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white dark:bg-dark-card text-gray-500">Atau masuk dengan</span>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-gray-600 dark:text-gray-400">
          Belum punya akun?{' '}
          <Link to="/signup" className="font-bold text-gold-primary hover:underline">
            Daftar sekarang
          </Link>
        </p>
      </div>
